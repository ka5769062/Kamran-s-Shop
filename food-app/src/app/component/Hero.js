    ...
    <div className="relative min-h-screen">
      ...
      <div className="container h-[calc(100vh-120px)] grid items-center">
        <div className="space-y-4 bg-[#ffffff98] w-fit p-4">
          ...
          <p className="text-gray-700 text-[14px] sm:text-[16px]">Sed ut perspiciatis un et quasi architecto beatae 
            <br/>vitae dicta sunt explicabo.</p>
            <button className="bg-accent text-white px-6 py-2 rounded-3xl sm:text-[16px]">View More</button>
